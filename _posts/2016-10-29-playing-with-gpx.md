...
<p class="text-center">
    <img style="max-width: 450px; width:100%" src="/static/posts/playing-with-gpx.png" alt="Map with missing data" />
</p>
...
<p class="text-center">
    <img style="max-width: 450px; width:100%" src="/static/posts/playing-with-gpx-fixed-map.png" alt="Map with resolved data" />
</p>
